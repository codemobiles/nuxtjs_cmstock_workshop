# Nuxt 3 CMS Stock Course EP.98 - Workshop - Frontend - Delete Product (Part 1)
    ...
    <a-row :gutter="[0, 10]">
        ...
        <a-col :span="24">
            <a-modal v-model:visible="visible">
                ...
                <template #footer>
                    <a-button @click="handleCancelDelete">Cancel</a-button>
                    <a-button
                        danger
                        type="primary"
                        html-type="submit"
...
const handleConfirmDelete = () => {
    console.log("delete, id: ", deleteProductId.value);
};
</script>
