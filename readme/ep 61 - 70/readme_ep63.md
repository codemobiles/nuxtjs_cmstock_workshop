# Nuxt 3 CMS Stock Course EP.63 - Workshop - Frontend - Register Page

## Outcome

-   [x] Create `register.vue` page using `Antdv`
-   [x] Implement `TailwindCSS` to `register.vue` page
...
1. Create `~/pages/register.vue` for login page
...
3. Go visit `http://localhost:3000/register` to see the result
